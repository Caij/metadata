...
public final class Metadata {
  ...
  public Metadata(Entry... entries) {
    this(/* presentationTimeUs= */ Util.TIME_UNSET, entries);
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + Util.hashCode(presentationTimeUs);
    return result;
  }
  ...
  public String toString() {
    return "entries="
        ...
        + (presentationTimeUs == Util.TIME_UNSET ? "" : ", presentationTimeUs=" + presentationTimeUs);
  }

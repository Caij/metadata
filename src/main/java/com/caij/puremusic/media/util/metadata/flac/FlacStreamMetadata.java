...
import com.caij.puremusic.media.util.metadata.ParsableBitArray;
...
import com.caij.puremusic.media.util.metadata.data.flac.PictureFrame;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

import static com.caij.puremusic.media.util.metadata.VorbisUtil.parseVorbisComments;
...
public final class FlacStreamMetadata {
  ...
  public long getDurationUs() {
    return totalSamples == 0 ? Util.TIME_UNSET : totalSamples * Util.MICROS_PER_SECOND / sampleRate;
  }
  ...
  public long getSampleNumber(long timeUs) {
    long sampleNumber = (timeUs * sampleRate) / Util.MICROS_PER_SECOND;
  ...
  private static Metadata concatenateVorbisMetadata(
    ...
    Metadata parsedVorbisComments = parseVorbisComments(vorbisComments);

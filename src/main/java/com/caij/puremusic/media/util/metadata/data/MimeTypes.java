...
import com.caij.puremusic.media.util.metadata.UnstableApi;
...
public final class MimeTypes {
  ...
  public static void registerCustomMimeType(
      String mimeType, String codecPrefix, int trackType) {
  ...
  public static boolean allSamplesAreSyncSamples(
    ...
    switch (mimeType) {
      ...
      case AUDIO_AAC:
        ...
        Mp4aObjectType objectType = getObjectTypeFromMp4aRFC6381CodecString(codec);
        if (objectType == null) {
          return false;
        }
        int encoding = objectType.getEncoding();
        ...
        return encoding != Util.ENCODING_INVALID && encoding != Util.ENCODING_AAC_XHE;
      default:
        return false;
    }
  }
  ...
  public static int getTrackType(String mimeType) {
    if (Util.isEmpty(mimeType)) {
      ...
      return Util.TRACK_TYPE_AUDIO;
    } else if (isVideo(mimeType)) {
      return Util.TRACK_TYPE_VIDEO;
    } else if (isText(mimeType)) {
      return Util.TRACK_TYPE_TEXT;
    } else if (isImage(mimeType)) {
      return Util.TRACK_TYPE_IMAGE;
  ...
  public static int getEncoding(String mimeType, String codec) {
    switch (mimeType) {
      case MimeTypes.AUDIO_MPEG:
        return Util.ENCODING_MP3;
      case MimeTypes.AUDIO_AAC:
        if (codec == null) {
          return Util.ENCODING_INVALID;
        }
        Mp4aObjectType objectType = getObjectTypeFromMp4aRFC6381CodecString(codec);
        if (objectType == null) {
          return Util.ENCODING_INVALID;
      ...
      case MimeTypes.AUDIO_AC3:
        return Util.ENCODING_AC3;
      case MimeTypes.AUDIO_E_AC3:
        return Util.ENCODING_E_AC3;
      case MimeTypes.AUDIO_E_AC3_JOC:
        return Util.ENCODING_E_AC3_JOC;
      case MimeTypes.AUDIO_AC4:
        return Util.ENCODING_AC4;
      case MimeTypes.AUDIO_DTS:
        return Util.ENCODING_DTS;
      case MimeTypes.AUDIO_DTS_HD:
        return Util.ENCODING_DTS_HD;
      case MimeTypes.AUDIO_DTS_EXPRESS:
        return Util.ENCODING_DTS_HD;
      case MimeTypes.AUDIO_DTS_X:
        return Util.ENCODING_DTS_UHD_P2;
      case MimeTypes.AUDIO_TRUEHD:
        return Util.ENCODING_DOLBY_TRUEHD;
      case MimeTypes.AUDIO_OPUS:
        return Util.ENCODING_OPUS;
      default:
        return Util.ENCODING_INVALID;
    }
  }
  ...
  /* package */ static Mp4aObjectType getObjectTypeFromMp4aRFC6381CodecString(String codec) {
    ...
    String objectTypeIndicationHex = Util.checkNotNull(matcher.group(1));
  ...
  /* package */ static final class Mp4aObjectType {
    ...
    public int getEncoding() {
      ...
      switch (audioObjectTypeIndication) {
        case 2:
          return Util.ENCODING_AAC_LC;
        case 5:
          return Util.ENCODING_AAC_HE_V1;
        case 29:
          return Util.ENCODING_AAC_HE_V2;
        case 42:
          return Util.ENCODING_AAC_XHE;
        case 23:
          return Util.ENCODING_AAC_ELD;
        case 22:
          return Util.ENCODING_AAC_ER_BSAC;
        default:
          return Util.ENCODING_INVALID;
      }
    }

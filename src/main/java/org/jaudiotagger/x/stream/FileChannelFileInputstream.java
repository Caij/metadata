 ...
 */
public final class FileChannelFileInputstream extends InputStream {

    /**
     * The file access to read from.<br>
     */
    private final SlideBufferFileChannel source;
     ...
     */
    public FileChannelFileInputstream(final SlideBufferFileChannel file) {
        super();
        if (file == null) {

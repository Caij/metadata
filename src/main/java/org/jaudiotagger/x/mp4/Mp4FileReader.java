...
public class Mp4FileReader extends AudioFileReader {
    ...
    @Override
    protected GenericAudioHeader getEncodingInfo(BuffInputStream raf) throws CannotReadException, IOException {
        return ir.read(raf);
    }

    @Override
    protected Tag getTag(BuffInputStream raf) throws CannotReadException, IOException {
        return tr.read(raf);
    }
}
